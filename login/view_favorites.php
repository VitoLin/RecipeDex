...
<html>
	<head>
		<title>RecipeDex Favorites</title>
        <link rel="stylesheet" href="../css/bootstrap.min.css">
        <?php include '../include/include.php' ?>
	</head>
	<body>

	<h1 style="text-align: center;"><?php echo $_SESSION['username'];?>'s Favorites</h1>
	<h1 style="text-align: center;">not set up -> just copied</h1>
